...
#' 
#' This data set pertains to the 10X demonstration PBMC 4K data and includes 4 objects: \code{PBMC_DR}, \code{PBMC_cellBarcodes}, and \code{PBMC_tod}.
#'
...
#' }
#' 
#' \code{PBMC_tod} was generated by running \code{PBMC_tod = Read10X('raw_gene_bc_matrices/GRCh38/')} and the barcodes \code{PBMC_cellBarcodes} with code{PBMC_cellBarcodes = colnames(Read10X('filtered_gene_bc_matrices/GRCh38/'))}.
#' 
#' @format \code{PBMC_DR} is a data.frame with 4 columns: RD1, RD2, Cluster, and Annotation.  \code{PBMC_tod} is a sparse matrix with rows representing genes, columns droplets, and entries number of unique molecular identifiers found.  \code{PBMC_cellBarcodes} is a vector containing the barcodes for droplets containing cells.
#' @usage data(PBMC)
#' @name PBMC
#' @docType data
