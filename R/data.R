...
#' 
#' This data set pertains to the 10X demonstration PBMC 4K data and includes 2 objects: \code{PBMC_DR} and \code{PBMC_cellBarcodes}
#'
...
#' }
#' 
#' \code{PBMC_cellBarcodes} was created with \code{PBMC_cellBarcodes = colnames(Read10X('filtered_gene_bc_matrices/GRCh38/'))}.
#' 
#' @format \code{PBMC_DR} is a data.frame with 4 columns: RD1, RD2, Cluster, and Annotation.  \code{PBMC_cellBarcodes} is a vector containing the barcodes for droplets containing cells.
#' @usage data(PBMC)
#' @name PBMC
#' @docType data
